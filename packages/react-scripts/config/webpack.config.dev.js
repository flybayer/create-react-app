...
// In development, we include the entire path so all assets can be loaded
// via localhost instead of from the browser extension package
...
module.exports = {
  ...
  plugins: [
    ...
    new WriteFileWebpackPlugin({test: /(\.html$|background\.bundle\.js$)/})
  ],
